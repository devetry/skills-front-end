        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="strip-url-auth">strip-url-auth <a href="https://travis-ci.org/sindresorhus/strip-url-auth"><img src="https://travis-ci.org/sindresorhus/strip-url-auth.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
<p>Strip the <a href="http://en.wikipedia.org/wiki/Basic_access_authentication">authentication</a> part of a URL</p>
</blockquote>
<h2 id="install">Install</h2>
<pre><code>$ npm install --save strip-url-auth</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-js">var stripUrlAuth = require('strip-url-auth');

stripUrlAuth('https://user:pass@sindresorhus.com');
//=&gt; 'https://sindresorhus.com'</code></pre>
