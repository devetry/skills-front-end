        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="trim-repeated">trim-repeated <a href="https://travis-ci.org/sindresorhus/trim-repeated"><img src="https://travis-ci.org/sindresorhus/trim-repeated.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
