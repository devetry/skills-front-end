        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="strict-uri-encode">strict-uri-encode <a href="https://travis-ci.org/kevva/strict-uri-encode"><img src="https://travis-ci.org/kevva/strict-uri-encode.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<pre><code class="language-js">var strictUriEncode = require('strict-uri-encode');

strictUriEncode('unicorn!foobar')
//=&gt; 'unicorn%21foobar'

strictUriEncode('unicorn*foobar')
//=&gt; 'unicorn%2Afoobar'</code></pre>
<h2 id="api">API</h2>
