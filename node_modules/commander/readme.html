...
else console.log(' without sauce');</code></pre>
...
<pre><code class="language-js">program
  .version('0.0.1', '-v, --version')</code></pre>
...
console.log(' drink: %j', program.drink);</code></pre>
...
console.log('environment:', envValue || "no environment given");</code></pre>
