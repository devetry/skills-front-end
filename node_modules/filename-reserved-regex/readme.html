        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="filename-reserved-regex">filename-reserved-regex <a href="https://travis-ci.org/sindresorhus/filename-reserved-regex"><img src="https://travis-ci.org/sindresorhus/filename-reserved-regex.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<pre><code>$ npm install --save filename-reserved-regex</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-js">var filenameReservedRegex = require('filename-reserved-regex');
