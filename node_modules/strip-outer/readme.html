        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="strip-outer">strip-outer <a href="https://travis-ci.org/sindresorhus/strip-outer"><img src="https://travis-ci.org/sindresorhus/strip-outer.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
