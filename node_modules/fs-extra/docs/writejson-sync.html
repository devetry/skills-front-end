        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="writejsonsyncfile-object-options">writeJsonSync(file, object, [options])</h1>
...
fs.writeJsonSync('./package.json', {name: 'fs-extra'})</code></pre>
<hr />
<p><strong>See also:</strong> <a href="outputjson-sync.html"><code>outputJsonSync()</code></a></p>
                                    </section>
