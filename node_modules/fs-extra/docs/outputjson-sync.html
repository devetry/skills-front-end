...
<p>Almost the same as <a href="writejson-sync.html"><code>writeJsonSync</code></a>, except that if the directory does not exist, it's created.</p>
...
console.log(data.name) // =&gt; JP</code></pre>
                                    </section>
