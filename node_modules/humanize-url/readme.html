        ...
        <main class="container-fluid">
            <div class="row">
                ...
                <section id="content" class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
                                        <h1></h1>
                    <h1 id="humanize-url">humanize-url <a href="https://travis-ci.org/sindresorhus/humanize-url"><img src="https://travis-ci.org/sindresorhus/humanize-url.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
<p>Humanize a URL: <code>http://sindresorhus.com</code> → <code>sindresorhus.com</code></p>
</blockquote>
<h2 id="install">Install</h2>
<pre><code>$ npm install --save humanize-url</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-js">var humanizeUrl = require('humanize-url');
